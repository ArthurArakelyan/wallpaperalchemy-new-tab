      ...
      patterns: [
        { from: "target/shared" },
        {
          ...
          transform: (content, absolutePath) => {
            // In development, we remove the background service worker from the manifest.
            // This is because the service worker is only generated by Workbox in production builds.
